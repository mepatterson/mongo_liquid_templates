h1. Mongo Liquid Templates (forked from Dynamic Liquid Templates by akitaonrails)
...
The requirement is to install Tobias' Liquid gem as well as the mongo stuff:
